...
/**
 * Executes imperative one-connection resource failure coverage against MySQL.
 */
@Testcontainers(disabledWithoutDocker = true)
class MySqlImperativeResourceFailureTest extends AbstractJdbcResourceFailureContract {
    @Container
    ...
    protected Config databaseConfig() {
        return MySqlImperativeTestSupport.config();
    }
}
