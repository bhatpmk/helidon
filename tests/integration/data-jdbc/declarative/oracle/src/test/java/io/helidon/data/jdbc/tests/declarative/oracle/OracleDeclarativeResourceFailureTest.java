...
/**
 * Executes declarative one-connection resource failure coverage against Oracle Database.
 */
@Testcontainers(disabledWithoutDocker = true)
class OracleDeclarativeResourceFailureTest extends AbstractJdbcResourceFailureContract {
    @Container
    ...
    protected Config databaseConfig() {
        return OracleDeclarativeTestSupport.config();
    }
}
