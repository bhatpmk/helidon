...
import io.helidon.data.jdbc.tests.contract.AbstractJdbcSqlEdgeContract;
...
/**
 * Executes declarative SQL edge cases against Oracle Database.
 */
@Testcontainers(disabledWithoutDocker = true)
class OracleDeclarativeSqlEdgeTest extends AbstractJdbcSqlEdgeContract {
    @Container
