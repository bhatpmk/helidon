...
import io.helidon.data.jdbc.tests.contract.AbstractJdbcUnicodeMarkerContract;
...
/**
 * Executes generated supplementary Unicode marker behavior against Oracle Database.
 */
@Testcontainers(disabledWithoutDocker = true)
class OracleDeclarativeUnicodeMarkerTest extends AbstractJdbcUnicodeMarkerContract {
    @Container
