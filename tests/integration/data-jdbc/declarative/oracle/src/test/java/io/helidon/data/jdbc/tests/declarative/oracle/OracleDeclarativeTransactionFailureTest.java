...
import io.helidon.data.jdbc.tests.contract.AbstractJdbcTransactionFailureContract;
...
/**
 * Executes generated-repository transaction failure behavior against Oracle Database.
 */
@Testcontainers(disabledWithoutDocker = true)
class OracleDeclarativeTransactionFailureTest extends AbstractJdbcTransactionFailureContract {
    @Container
