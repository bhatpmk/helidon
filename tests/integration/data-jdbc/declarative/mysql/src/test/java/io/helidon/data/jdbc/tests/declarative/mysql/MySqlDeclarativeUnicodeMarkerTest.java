...
/**
 * Executes generated supplementary Unicode marker behavior against MySQL.
 */
@Testcontainers(disabledWithoutDocker = true)
class MySqlDeclarativeUnicodeMarkerTest extends AbstractJdbcUnicodeMarkerContract {
    @Container
