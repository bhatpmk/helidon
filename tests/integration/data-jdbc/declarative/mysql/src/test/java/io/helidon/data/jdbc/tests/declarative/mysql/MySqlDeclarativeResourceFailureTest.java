...
/**
 * Executes declarative one-connection resource failure coverage against MySQL.
 */
@Testcontainers(disabledWithoutDocker = true)
class MySqlDeclarativeResourceFailureTest extends AbstractJdbcResourceFailureContract {
    @Container
    ...
    protected Config databaseConfig() {
        return MySqlDeclarativeTestSupport.config();
    }
}
