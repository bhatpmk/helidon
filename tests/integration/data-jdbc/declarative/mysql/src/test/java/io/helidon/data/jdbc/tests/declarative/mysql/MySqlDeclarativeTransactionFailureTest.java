...
/**
 * Executes generated-repository transaction failure behavior against MySQL.
 */
@Testcontainers(disabledWithoutDocker = true)
class MySqlDeclarativeTransactionFailureTest extends AbstractJdbcTransactionFailureContract {
    @Container
