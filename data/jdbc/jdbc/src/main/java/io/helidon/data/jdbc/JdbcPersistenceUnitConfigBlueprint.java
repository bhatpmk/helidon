 ...
 * <p>
 * The generated public configuration type is read from {@code data.persistence-units.jdbc}. Exactly one inherited SQL
...
interface JdbcPersistenceUnitConfigBlueprint extends SqlConfig {
    ...
    /**
     * Optional classpath initialization script executed before the client is published.
     *
